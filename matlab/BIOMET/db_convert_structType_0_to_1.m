function structType1 = db_convert_structType_0_to_1(structType0)
% structType1 = db_convert_structType_0_to_1(structType0)
%
% Converts the structure type 0:
%                          Struct(ind).Variable 
%                     to type 1: 
%                          Struct.Variable(ind)
%
...
%
% Notes:
%   The original function was created by Copilot (collapseSamplesWithFlattenedInnerArrays.m)
...
%   % out = db_convert_structType_0_to_1(sample);
